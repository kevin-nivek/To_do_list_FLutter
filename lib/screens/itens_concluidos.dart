...
import 'itens_to_do.dart';

int _selectedIndex = 0;

class TarefasItensF extends StatefulWidget {
  final String tarefa;
  final int indicieT;

  TarefasItensF(this.tarefa, this.indicieT);

  @override
  _TarefasItensFState createState() => _TarefasItensFState();
}

class _TarefasItensFState extends State<TarefasItensF> {
  String observacao;
  Item _lastRemove;
  int _lastRemovedpos;
    ...
    setState(() {
      ...
      if (_selectedIndex == 0) {
        Navigator.pushReplacement(context, MaterialPageRoute(
            builder: (context) =>
                TarefasItens(tarefas[widget.indicieT], widget.indicieT)));
      }
      if (_selectedIndex == 1) {
        showDialog(
            context: context,
